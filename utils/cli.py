import argparse
from config import AVAILABLE_MASKS, DATAPATH

def parse_args():
    parser = argparse.ArgumentParser()
    # TODO: remove my path here
    parser.add_argument("--dataset_path", type=str, default=DATAPATH, help="The dataset .pkl you want to perturb")
    ...
    parser.add_argument("--device", type=str, default="cuda:0", help="Device to use (cuda:index/cpu)")
