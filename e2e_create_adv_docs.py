...
from attacks.end2end_attack import e2e_attack_pix2struct
...
def single_question_attack():
    ...
    autoprocessor = Pix2StructModelProcessor() #TODO Remove and make only one processor
...
if __name__ == '__main__':
    ...
    denial_of_service_attack() # TODO: the loss is decreasing instead increasing
